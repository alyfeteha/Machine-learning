...
if __name__ == "__main__":
    imgs, imgs_counter, files_counter = read_file("C:/Users/alyfe/OneDrive/Desktop/faces_dataset")
    imgs_no_face, imgs_no_face_counter, files_no_face_counter = read_file("C:/Users/alyfe/OneDrive/Desktop/no_faces_nigga")
    testing, training, split_labels_vectors = data_split(imgs, imgs_counter, files_counter, True)
    testing_no_face, training_no_face, split_labels_vector_no_face = data_split(imgs_no_face, imgs_no_face_counter,files_no_face_counter, False)
